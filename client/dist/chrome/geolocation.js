...
const getGeolocation = () => {
  ...
  const geoSuccess = (position) => {
    ...
    fetch('ec2-52-33-110-254.us-west-2.compute.amazonaws.com/api/users/getGeolocation', {
      method: 'GET',
      headers: {
...
const updateGeolocation = (geolocation) => {
  ...
  fetch('ec2-52-33-110-254.us-west-2.compute.amazonaws.com/api/users/updateGeolocation', {
    method: 'POST',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
