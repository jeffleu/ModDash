...
class App extends React.Component {
  ...
  fetchAndUpdateEvents() {
    ...
    fetch('ec2-52-33-110-254.us-west-2.compute.amazonaws.com:9000/api/calendar/getDayEvents', {
      method: 'GET',
  ...
  displayTransitMode() {
    ...
    fetch('ec2-52-33-110-254.us-west-2.compute.amazonaws.com:9000/api/users/getTransit', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'authorization': token
